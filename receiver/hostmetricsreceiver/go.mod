...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/gopsutilenv v0.141.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.141.0
